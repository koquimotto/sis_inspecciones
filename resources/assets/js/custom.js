(function () {
  ...
  /*Start Notification Scroll */
  const headerNotifScroll = document.getElementById("header-notification-scroll");
  if (headerNotifScroll && window.SimpleBar) {
    new SimpleBar(headerNotifScroll, { autoHide: true });
  }
  /*End Notification Scroll */
  
  /* header dropdowns scroll */
  const headerShortcutScroll = document.getElementById("header-shortcut-scroll");
  if (headerShortcutScroll && window.SimpleBar) {
    new SimpleBar(headerShortcutScroll, { autoHide: true });
  }
