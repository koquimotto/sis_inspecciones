...
@section('title', 'Equipos observados - EL CUMBE EIRL')
...
@section('content')
                  ...
                  <div class="md:flex block items-center justify-between my-[1.5rem] page-header-breadcrumb">
                      <div>
                        <p class="font-semibold text-[1.125rem] text-defaulttextcolor dark:text-defaulttextcolor/70 !mb-0 ">Observaciones</p>
