...
@section('content')
    <div
        class="wizard-create-page"
        x-data="{
            step: 1,
            maxStep: 6,
            next() { if (this.step < this.maxStep) this.step++; },
            prev() { if (this.step > 1) this.step--; },
            goToStep(n) { this.step = n; },
            isActive(n) { return this.step === n; },
            isDone(n) { return this.step > n; },
            progress() { return Math.round((this.step / this.maxStep) * 100); }
        }"
    >
        <div class="wizard-create-container">
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="wiz-page-subtitle max-w-4xl">
                                        Completa el proceso guiado paso a paso para registrar la inspección, asignar equipos,
            ...
            <div class="wiz-card mb-4">
                <div class="wiz-card-body">
                    <div class="wizard-top-steps">
                        <div class="wizard-step" :class="{ 'active': isActive(1), 'done': isDone(1) }" @click="goToStep(1)">
                            <div class="wizard-step-badge">
                                <template x-if="isDone(1)">
                        ...
                        <div class="wizard-step" :class="{ 'active': isActive(2), 'done': isDone(2) }" @click="goToStep(2)">
                            <div class="wizard-step-badge">
                                <template x-if="isDone(2)">
                                    <iconify-icon icon="solar:check-read-outline" width="16"></iconify-icon>
                                </template>
                                <template x-if="!isDone(2)">
                                    <span>2</span>
                        ...
                        <div class="wizard-step" :class="{ 'active': isActive(3), 'done': isDone(3) }" @click="goToStep(3)">
                            <div class="wizard-step-badge">
                                <template x-if="isDone(3)">
                                    <iconify-icon icon="solar:check-read-outline" width="16"></iconify-icon>
                                </template>
                                <template x-if="!isDone(3)">
                                    <span>3</span>
                        ...
                        <div class="wizard-step" :class="{ 'active': isActive(4), 'done': isDone(4) }" @click="goToStep(4)">
                            <div class="wizard-step-badge">
                                <template x-if="isDone(4)">
                                    <iconify-icon icon="solar:check-read-outline" width="16"></iconify-icon>
                                </template>
                                <template x-if="!isDone(4)">
                                    <span>4</span>
                        ...
                        <div class="wizard-step" :class="{ 'active': isActive(5), 'done': isDone(5) }" @click="goToStep(5)">
                            <div class="wizard-step-badge">
                                <template x-if="isDone(5)">
                                    <iconify-icon icon="solar:check-read-outline" width="16"></iconify-icon>
                                </template>
                                <template x-if="!isDone(5)">
                                    <span>5</span>
                            ...
                            <div>
                                ...
                                <div class="wizard-step-subtitle">Levantamiento</div>
                            </div>
                        </div>

                        <div class="wizard-step" :class="{ 'active': isActive(6), 'done': isDone(6) }" @click="goToStep(6)">
                            <div class="wizard-step-badge">
                                <template x-if="isDone(6)">
                                    <iconify-icon icon="solar:check-read-outline" width="16"></iconify-icon>
                                </template>
                                <template x-if="!isDone(6)">
                                    <span>6</span>
                            ...
                            <div>
                                ...
                                <div class="wizard-step-subtitle">Certificado</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="wizard-layout">
                ...
                <div class="space-y-4">
                    {{-- PASO 1 --}}
                    <section class="wiz-card" x-show="step === 1" x-cloak>
                        ...
                        <div class="wiz-card-body">
                            ...
                            <div class="wizard-nav-footer">
                                <div class="text-[0.74rem] text-slate-500">Paso 1 de 6</div>
                    ...
                    {{-- PASO 2 --}}
                    <section class="wiz-card" x-show="step === 2" x-cloak>
                        <div class="wiz-card-header">
                            <div class="flex items-start gap-3">
                        ...
                        <div class="wiz-card-body">
                            ...
                            <div class="wizard-nav-footer">
                                <button class="wiz-btn wiz-btn-light" @click="prev()">
                                    <iconify-icon icon="solar:arrow-left-outline" width="16"></iconify-icon>
                                    Anterior
                                </button>

                                <div class="text-[0.74rem] text-slate-500">Paso 2 de 6</div>
                    ...
                    {{-- PASO 3 --}}
                    <section class="wiz-card" x-show="step === 3" x-cloak>
                        <div class="wiz-card-header">
                            <div class="flex items-start gap-3">
                        ...
                        <div class="wiz-card-body">
                            ...
                            <div class="wizard-nav-footer">
                                ...
                                <div class="text-[0.74rem] text-slate-500">Paso 3 de 6</div>
                    ...
                    {{-- PASO 4 --}}
                    <section class="wiz-card" x-show="step === 4" x-cloak>
                        <div class="wiz-card-header">
                            <div class="flex items-start gap-3">
                        ...
                        <div class="wiz-card-body">
                                ...
                                <div class="result-option result-approved">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-[0.73rem] text-emerald-700/80 mt-2">Sin hallazgos relevantes.</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="result-option result-observed">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-[0.73rem] text-amber-700/80 mt-2">Con levantamiento pendiente.</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="result-option result-rejected">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-[0.73rem] text-rose-700/80 mt-2">Riesgo alto o incumplimiento crítico.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="wizard-nav-footer">
                                ...
                                <div class="text-[0.74rem] text-slate-500">Paso 4 de 6</div>
                    ...
                    {{-- PASO 5 --}}
                    <section class="wiz-card" x-show="step === 5" x-cloak>
                        <div class="wiz-card-header">
                            <div class="flex items-start gap-3">
...
3. Reposición de señalética faltante en área adyacente.</textarea>
                            ...
                            <div class="wizard-nav-footer">
                                ...
                                <div class="text-[0.74rem] text-slate-500">Paso 5 de 6</div>
                    ...
                    {{-- PASO 6 --}}
                    <section class="wiz-card" x-show="step === 6" x-cloak>
                        <div class="wiz-card-header">
                            <div class="flex items-start gap-3">
                    ...
                    <div class="summary-panel space-y-4">
                        <section class="wiz-card">
                            <div class="wiz-card-header">
                                ...
                                <span class="badge bg-primary/10 text-primary" x-text="progress() + '%'"></span>
                            </div>
                            ...
                            <div class="wiz-card-body">
                                <div class="space-y-3">
                                    ...
                                    <div class="summary-item">
                                        <div class="summary-item-label">Paso actual</div>
                                        <div class="summary-item-value" x-text="'Paso ' + step + ' de ' + maxStep"></div>
                                    </div>
                                </div>
